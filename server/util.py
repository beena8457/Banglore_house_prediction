...
def load_saved_artifacts():
    ...
    global __model
    with open("./artifacts/benglore_home_prices_model.pickle", 'rb') as f:
...
if __name__ == '__main__':
    ...
    print(get_estimated_price('KR Puram', 1000, 2, 2, 3))
    print(get_estimated_price('Electronic City', 1000, 2, 2, 3))
